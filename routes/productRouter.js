...
router.post("/", userMiddleware.authorize, userMiddleware.isSeller, 
productMiddleware.postValidate, productController.create);

router.put("/:id", userMiddleware.authorize, userMiddleware.isSeller, productMiddleware.getById, productMiddleware.getBySellerId, productMiddleware.postValidate, productController.update);
